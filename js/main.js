...
const renderer = new THREE.WebGLRenderer({ canvas, antialias: !IS_PHONE });
renderer.setPixelRatio(Math.min(devicePixelRatio, IS_PHONE ? 1.6 : 2));
...
sunLight.shadow.mapSize.set(IS_PHONE ? 2048 : 4096, IS_PHONE ? 2048 : 4096);
